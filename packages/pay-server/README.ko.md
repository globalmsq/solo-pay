...
MSQ Pay Server는 블록체인 기반 결제 시스템의 백엔드 API 서버입니다. Fastify 프레임워크와 viem을 사용하여 멀티체인 ERC-20 토큰 결제를 처리합니다.
...
자세한 API 문서는 [docs/api/payments.md](../../docs/api/payments.md)를 참고하세요.
...
MSQ Pay Server는 **완전한 멀티체인 아키텍처**를 지원합니다. 체인 설정은 데이터베이스에서 동적으로 관리됩니다.
...
# 로그 확인
docker-compose logs -f pay-server
```
...
배포 가이드: [docs/deployment/payments-setup.md](../../docs/deployment/payments-setup.md)

## 문서

- [API 레퍼런스](../../docs/api/payments.md)
- [아키텍처 문서](../../docs/architecture-payments.md)
- [구현 가이드](../../docs/implementation/payments-api.md)
- [배포 가이드](../../docs/deployment/payments-setup.md)
