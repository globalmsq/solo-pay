...
Solo Pay Subgraph indexes PaymentGateway smart contract events using The Graph protocol and provides a queryable GraphQL API.
...
graph deploy --studio solo-pay-polygon-amoy
```
...
```typescript
// packages/demo/src/lib/subgraph.ts
