 ...
 * 2. 상점서버: orderId 생성, 상품 가격 조회, 총액 계산, 상점 설정에서 체인/토큰 조회
 * 3. 상점서버 → 결제서버: createPayment 요청
 * 4. 결제서버: paymentId 생성 (merchantId + orderId 기반)
 * 5. 상점서버 → 클라이언트: paymentId, orderId, 결제 정보 반환
 *
 * ⚠️ SECURITY:
